package com.example.admin_cc_questionback.security;
...
public class JwtUtils {
    ...
    private static String generateHMACToken(String subject, String roles, String secret, int expirationInMinutes) throws JOSEException {
    ...
    private static boolean verifyHMACToken(SignedJWT jwt, String secret) throws ParseException, JOSEException {
